...
#endif
	PORTB &= ~(1<<0);	//2016-11-16	UWA		light the RX LED
...
#endif
		int recvLength = length;	//2016-11-16	UWA
...
{
#if 0	//2016-11-29
    PinTgl(PIN_A0);	//2016-11-28	UWA - indicate all USb endpoint interrupts
#endif
	SetEP(0);
	if (!ReceivedSetupInt())
		return;
...
void USBDevice_::attach()
{
	...
	TX_RX_LED_INIT;
#endif
	DDRD |= (1<<5);	//2016-11-16	UWA
	DDRB |= (1<<0); //2016-11-16	UWA
